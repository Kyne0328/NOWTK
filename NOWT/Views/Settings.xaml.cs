...
public partial class Settings : UserControl
{
    ...
    private async void Button_Click1Async(object sender, RoutedEventArgs e)
    {
        ...
        AutoUpdater.Start(
            "https://raw.githubusercontent.com/Kyne0328/NOWTK/main/NOWT/VersionInfo.xml"
        );
    ...
    private static Task<string> GetLatestVersionAsync()
    {
        ...
        xml.Load("https://raw.githubusercontent.com/Kyne0328/NOWTK/main/NOWT/VersionInfo.xml");
